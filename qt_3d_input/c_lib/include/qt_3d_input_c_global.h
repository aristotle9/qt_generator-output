#ifndef QT_3D_INPUT_C_GLOBAL_H
#define QT_3D_INPUT_C_GLOBAL_H
...
#include "qt_3d_input_c_exports.h"
...
template<typename T>
void qt_3d_input_c_call_destructor(T* x) {
    x->~T();
}


#endif // QT_3D_INPUT_C_GLOBAL_H
