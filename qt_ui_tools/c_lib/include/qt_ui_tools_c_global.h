#ifndef QT_UI_TOOLS_C_GLOBAL_H
#define QT_UI_TOOLS_C_GLOBAL_H
...
#include "qt_ui_tools_c_exports.h"
...
template<typename T>
void qt_ui_tools_c_call_destructor(T* x) {
    x->~T();
}


#endif // QT_UI_TOOLS_C_GLOBAL_H
