#ifndef QT_WIDGETS_C_GLOBAL_H
#define QT_WIDGETS_C_GLOBAL_H
...
#include "qt_widgets_c_exports.h"
...
template<typename T>
void qt_widgets_c_call_destructor(T* x) {
    x->~T();
}


#endif // QT_WIDGETS_C_GLOBAL_H
